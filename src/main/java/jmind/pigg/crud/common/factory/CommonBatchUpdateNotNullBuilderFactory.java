...
import jmind.pigg.crud.common.builder.CommonUpdateNotNullBuilder;
 ...
 * @author xieweibo
 */
public class CommonBatchUpdateNotNullBuilderFactory extends AbstractCommonBuilderFactory {
    ...
    Builder createCommonBuilder(CrudMeta cm) {
        return new CommonUpdateNotNullBuilder(cm.getPropertyId(), cm.getProperties(), cm.getColumns());
    }
