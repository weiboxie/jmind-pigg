 ...
 * @author xieweibo
 */
final public class PiggDaoScanner implements BeanFactoryPostProcessor {

  private final static InternalLogger logger = InternalLoggerFactory.getInstance(PiggDaoScanner.class);
  ...
  public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
    ...
    for (Class<?> daoClass : findpiggDaoClasses()) {
