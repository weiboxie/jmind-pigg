...
public class DbTest {
  ...
  private final static UserDao dao = pigg.create(UserDao.class);
  ...
  public void testQueryEmpty() throws Exception {
    boolean old = pigg.isCompatibleWithEmptyList();
    ...
    pigg.setCompatibleWithEmptyList(old);
  }
  ...
  public void testQueryEmpty2() throws Exception {
    ...
    UserDao dao2 = pigg.create(UserDao.class);
    try {
  ...
  static interface UserDao {
    ...
    public int updateUsers(@Param("ids") List<Integer> ids, @Param("name") String name);
