...
public class BillShardingTest {
  ...
  public void before() throws Exception {
    ...
    bill1Dao = pigg.create(Bill1Dao.class);
    bill2Dao = pigg.create(Bill2Dao.class);
    bill3Dao = pigg.create(Bill3Dao.class);
    bill4Dao = pigg.create(Bill4Dao.class);
    billDao = pigg.create(BillDao.class);
    simpleBillDao = pigg.create(SimpleBillDao.class);
  }
  ...
  interface Bill1Dao extends IBillDao {
    ...
    int insert(@Param("table") String table, Bill bill);
